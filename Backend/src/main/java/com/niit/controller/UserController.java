...
@RestController //spring understands that this is web service 
public class UserController {

	@Autowired
	UsersDao usersDao;
	//jackson dependencies i.e. jackson core and jackson databind converts json to objects
	...
	public void registerUser(@RequestParam("file") MultipartFile file, @RequestParam("name") String name,
		...
		Path path = Paths.get("D:/New folder/AngularFrontend/WebContent/"
				+ name + ".jpg");
		if (file != null) {
			try {
