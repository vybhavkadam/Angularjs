...
app.controller("BlogController",function($scope,$http,$rootScope)	
					...
					$http.get("http://localhost:8087/Backend/viewMyBlogs/"+$rootScope.uname)
							 ...
							 $scope.newBlog={};
								...
								$scope.addBlog=function(newBlog)
								{
									var dataObj = {
											...
											postedby:$rootScope.uname //global variable , used from cookie
							 		};
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:8087/Backend/addBlog',dataObj);
									 $http.get("http://localhost:8087/Backend/viewMyBlogs/"+$rootScope.uname)
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:8087/Backend/updateBlog",edit);
					$http.get("http://localhost:8087/Backend/viewMyBlogs/"+$rootScope.uname)
					    .then(function (response) {
				...
				$http.post("http://localhost:8087/Backend/deleteBlog",del);
					$http.get("http://localhost:8087/Backend/viewMyBlogs/"+$rootScope.uname)
					    .then(function (response) {
