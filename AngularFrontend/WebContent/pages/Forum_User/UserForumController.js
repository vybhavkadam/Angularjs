...
app.controller("UserForumController",function($scope,$http,$rootScope)	
					...
					console.log(" in forum controller");
							 ...
							 $http.get("http://localhost:8087/Backend/viewForum")
							 ...
							 $scope.newForum={};
								...
								$scope.addForum=function(newForum)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:8081/AngularBackend/addForum',dataObj);
									 $http.get("http://localhost:8081/AngularBackend/viewForum")
								...
								$scope.answer=function(forum)
								{
									...
									answer:$scope.answerforum.answer
									 ...
									 $http.post('http://localhost:8081/AngularBackend/answerForum',ans);
									$http.get("http://localhost:8081/AngularBackend/viewForum")
								    .then(function (response) {
								...
								$scope.viewanswers=function(forum)
								{
									...
									console.log("forumid:"+$scope.answerforum.forum_id);
									 $http.get("http://localhost:8081/AngularBackend/viewAnswers/"+$scope.answerforum.forum_id)
									    .then(function (response) {
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:8081/AngularBackend/updateForum",edit);
					 $http.get("http://localhost:8081/AngularBackend/viewForum")
					    .then(function (response) {
				...
				$http.post("http://localhost:8081/AngularBackend/deleteForum",del)
					
					 $http.get("http://localhost:8081/AngularBackend/viewForums")
					    .then(function (response) {
					    	$scope.forums = response.data;
					    	console.log("data:"+response.data);
					    });
