app.controller("AdminJobsController",function($scope,$http,$rootScope)	
					...
					console.log(" in jobs controller");
							 ...
							 $http.get("http://localhost:8087/Backend/viewJobs")
							 ...
							 $scope.newJobs={};
								...
								$scope.addJobs=function(newJobs)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:8087/Backend/addJobs',dataObj);
									 $http.get("http://localhost:8087/Backend/viewJobs")
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:8087/Backend/updateJob",edit);
					 $http.get("http://localhost:8087/Backend/viewJobs")
					    .then(function (response) {
				...
				$http.post("http://localhost:8087/Backend/deleteJob",del);
					 $http.get("http://localhost:8087/Backend/viewJobs")
					    .then(function (response) {
